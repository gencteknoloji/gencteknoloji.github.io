              ...
              <div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="mt-8">
                      <button 
                        onClick={() => setIsTodaySalesOpen(!isTodaySalesOpen)}
                        className="w-full flex items-center justify-between p-4 glass-panel hover:bg-white/5 hover:border-indigo-500/30 transition-all cursor-pointer group"
                      >
                        <div className="flex items-center gap-3">
                          <span className="relative flex h-2 w-2">
                            <span className={`absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75 ${isTodaySalesOpen ? 'animate-ping' : ''}`} />
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
                          </span>
                          <h3 className="text-sm font-bold text-white group-hover:text-indigo-300 transition-colors">Bugünkü Satışlar Geçmişi</h3>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className={`p-1 rounded bg-white/5 text-secondary transition-transform duration-300 ${isTodaySalesOpen ? 'rotate-180 bg-indigo-500/20 text-indigo-300' : ''}`}>
                      ...
                      <div className={`grid transition-[grid-template-rows,opacity] duration-300 ease-in-out ${isTodaySalesOpen ? 'grid-rows-[1fr] opacity-100 mt-3' : 'grid-rows-[0fr] opacity-0 mt-0'}`}>
                                ...
                                {(() => {
                                  ...
                                  return (
                                    <div className={`glass-panel p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 ${
                                      isPositive 
                                        ? 'bg-gradient-to-r from-emerald-950/20 to-emerald-900/10 border border-emerald-500/15' 
                                        : 'bg-gradient-to-r from-red-950/20 to-red-900/10 border border-red-500/15'
                                    }`}>
                                      <div>
                                        <h5 className={`text-[11px] font-bold uppercase tracking-wider ${isPositive ? 'text-emerald-400' : 'text-red-400'}`}>
                                          Genel Kar - Zarar
                                        </h5>
